...
const createAttributes = (
  ...
  return metadataVariable.attributeReferences?.map((attributeReference: BFFAttributeReference) => {
...
const checkIfSpecifiedHeadlineLevelExist = (presentation: BFFPresentationGroup) => {
