...
import {formDefWithOptionalGroupWithTwoCollectionVars} from "../__mocks__/data/formDef";
      ...
      <div>
        <Stack spacing={2}>
          <FormGenerator
            ...
            formSchema={formDefWithOptionalGroupWithTwoCollectionVars as FormSchema}
          />
        </Stack>
      </div>
    </>
