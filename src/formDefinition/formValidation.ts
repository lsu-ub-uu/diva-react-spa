...
import { BFFMetadataNumberVariable, BFFMetadataTextVariable } from '../config/bffTypes';

export const createTextVariableValidation = (textVariable: BFFMetadataTextVariable) => {
  const pattern = textVariable.regEx;
  return { type: 'regex', pattern };
};

export const createNumberVariableValidation = (numberVariable: BFFMetadataNumberVariable) => {
